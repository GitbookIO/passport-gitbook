...
function Strategy(options, verify) {
    options = options || {};
    options.authorizationURL = options.authorizationURL || 'https://www.gitbook.com/login/oauth/authorize';
    options.tokenURL = options.tokenURL || 'https://www.gitbook.com/login/oauth/access_token';
    ...
    this.name = 'gitbook';
    this._userProfileURL = options.userProfileURL || 'https://api.gitbook.com/account';
